"""Allow LLM enhancement jobs for interest-core candidates.

Revision ID: 0035_interest_core_candidate_enhancement
Revises: 0034_interest_core_briefs
...
revision: str = "0035_interest_core_candidate_enhancement"
down_revision: str | None = "0034_interest_core_briefs"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_JOB_TYPES_WITH_CANDIDATE_ENHANCEMENT = (
...
def upgrade() -> None:
    _replace_job_type_constraint(_JOB_TYPES_WITH_CANDIDATE_ENHANCEMENT)
