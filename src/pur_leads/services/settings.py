...
DEFAULT_SETTINGS: dict[str, SettingDefault] = {
    ...
    "interest_core_llm_enhancement_chunk_max_attempts": SettingDefault(2, "int"),
    ...
    "catalog_auto_extract_after_ingest_enabled": SettingDefault(False, "bool"),
    "catalog_extract_telegram_message_text_enabled": SettingDefault(False, "bool"),
    "telegram_feature_profiles_enabled": SettingDefault(False, "bool"),
    "telegram_feature_active_profile_id": SettingDefault(None, "string"),
    "telegram_feature_profiles": SettingDefault({}, "json"),
    "telegram_feature_profile_assignment_rules": SettingDefault([], "json"),
    "catalog_quality_idle_validation_enabled": SettingDefault(True, "bool"),
    "catalog_quality_idle_batch_size": SettingDefault(5, "int"),
    "catalog_quality_idle_max_active_jobs": SettingDefault(0, "int"),
    ...
    "llm_adaptive_timeout_max_seconds_by_task": SettingDefault(
        {
            ...
            "lead_detection": 45,
            "lead_candidate_arbitration": 120,
            "ocr": 180,
        },
        "json",
    ),
    ...
    "lead_candidate_arbitration_provider": SettingDefault("zai", "string"),
    "lead_candidate_arbitration_base_url": SettingDefault(
        "https://api.z.ai/api/coding/paas/v4",
        "string",
    ),
    "lead_candidate_arbitration_model": SettingDefault("GLM-5.1", "string"),
    "lead_candidate_arbitration_temperature": SettingDefault(0.0, "float"),
    "lead_candidate_arbitration_max_tokens": SettingDefault(2048, "int"),
    ...
    "external_page_fetch_timeout_seconds": SettingDefault(600, "int"),
