...
telegram_prepared_documents_table = Table(
    ...
    Column("artifact_id", String(160), nullable=False),
    ...
    Column("reply_to_message_id", Integer, nullable=True),
    Column("thread_id", String(80), nullable=True),
    Column("thread_key", String(80), nullable=False),
    Column("date", String(64), nullable=True),
    Column("message_url", Text, nullable=True),
    Column("raw_text", Text, nullable=True),
    Column("clean_text", Text, nullable=True),
    Column("lemmas_text", Text, nullable=True),
    Column("normalization_lang", String(32), nullable=False),
    Column("tokens_json", JSON, nullable=True),
    Column("lemmas_json", JSON, nullable=True),
    Column("pos_tags_json", JSON, nullable=True),
    Column("token_map_json", JSON, nullable=True),
    Column("token_count", Integer, nullable=False),
    Column("has_text", Boolean, nullable=False),
    Column("normalization_status", String(64), nullable=False),
    Column("normalization_error", Text, nullable=True),
    Column("payload_json", JSON, nullable=True),
    Column("feature_json", JSON, nullable=True),
    Column("created_at", DateTime(timezone=True), nullable=False),
    Column("updated_at", DateTime(timezone=True), nullable=False),
)
