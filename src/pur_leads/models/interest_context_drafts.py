...
interest_intent_layers_table = Table(
    ...
    Column("exclude_lemmas_json", JSON, nullable=True),
    Column("exclude_phrases_json", JSON, nullable=True),
    Column("semantic_negative_examples_json", JSON, nullable=True),
    Column("semantic_negative_threshold", Float, nullable=False),
